    ...
    <>
      ...
      <Container size="90%">
        ...
        <Center>
          <Text ta={"center"} fw={400} fz={23} c={"#535862"} maw={850}>
            We offer our clients consulting, advisory, and specialized engineering
            services with a focus on energy infrastructure, oil & gas facilities,
      ...
      <Container size="lg">
        ...
        <SimpleGrid cols={{ base: 1, md: 2 }} spacing="xl">
          ...
          <Card shadow="sm" padding="lg" radius="24px" style={{ border: "0.5px solid #090909" }}>
            <Group wrap="nowrap" >
              <div style={{ borderRadius: "50%", padding: "16px", backgroundColor: "#FC611138" }}>
                <Image
              ...
              <div>
                <Group wrap="nowrap" justify="space-between" >
                  ...
                  <div style={{ borderRadius: "10px", padding: "5px", backgroundColor: "#FC611138" }}>
                ...
                <Text fz={19} fw={400} c="#4A4A4C" mt="sm">
                  Upstream, midstream, and downstream operations including refineries, processing plants, and distribution systems.
                </Text>
              </div>
          ...
          <Card shadow="sm" padding="lg" radius="24px" style={{ border: "0.5px solid #090909" }}>
            <Group wrap="nowrap" >
              ...
              <div>
                ...
                <Text fz={19} fw={400} c="#4A4A4C" mt="sm">
                  Design and implementation of oil, gas, and water pipeline systems with advanced monitoring and control systems.
                </Text>
              </div>
          ...
          <Card shadow="sm" padding="lg" radius="24px" style={{ border: "0.5px solid #090909" }}>
            <Group wrap="nowrap" >
              ...
              <div>
                ...
                <Text fz={19} fw={400} c="#4A4A4C" mt="sm">
                  Compressed and liquefied gas storage, transportation, and distribution infrastructure solutions.
                </Text>
              </div>
          ...
          <Card shadow="sm" padding="lg" radius="24px" style={{ border: "0.5px solid #090909" }}>
            <Group wrap="nowrap" >
              ...
              <div>
                ...
                <Text fz={19} fw={400} c="#4A4A4C" mt="sm">
                  Critical infrastructure development including power generation, water treatment, and industrial facilities.
                </Text>
              </div>
      ...
      <Container size="xl">
        <div style={{ backgroundColor: "#FC6111", maxHeight:"400px", width:"100%"}}>
          ...
          <Space h={"50px"} />
          <Group  justify="center">
            <Button color="#090909" c={"white"}>Get in Touch</Button>
            <Button
              color="white"
              // variant="subtle"
              c="#FC6111"
